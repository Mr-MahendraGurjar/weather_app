...
import 'package:weather_app/app/widgets/daily/info_daily_card.dart';
import 'package:weather_app/app/widgets/status/status_data.dart';
import 'package:weather_app/app/widgets/status/status_weather.dart';
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Row(
                            ...
                            children: [
                              Image.asset(statusWeather.getImage7Day(weatherCodeDaily[index]), scale: 3),
                              const SizedBox(width: 5),
                              Expanded(
                                child: Text(statusWeather.getText(weatherCodeDaily[index]),
                                    style: labelLarge, overflow: TextOverflow.ellipsis),
                              ),
                            ],
                          ),
                        ),
                        Expanded(
                          child: Row(
                            ...
                            children: [
                              Text(statusData.getDegree((weatherData.temperature2MMin ?? [])[index]?.round()),
                                  style: labelLarge),
                              Text(' / ', style: bodyMediumGrey),
                              Text(statusData.getDegree((weatherData.temperature2MMax ?? [])[index]?.round()),
