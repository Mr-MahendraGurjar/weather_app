...
import 'package:weather_app/app/api/api.dart';
import 'package:weather_app/app/api/city.dart';
...
import 'package:weather_app/app/widgets/button.dart';
import 'package:weather_app/app/widgets/text_form.dart';
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
                ...
                leading: widget.isStart
                    ...
                    : IconButton(
                        onPressed: () => Get.back(),
                        icon: const Icon(Iconsax.arrow_left_1, size: 20),
                        splashColor: Colors.transparent,
                        highlightColor: Colors.transparent),
                automaticallyImplyLeading: false,
                title: Text('searchCity'.tr,
                    style:
                        context.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600, fontSize: 18))),
            body: SafeArea(
              ...
              Column(children: [
                Flexible(
                  ...
                  Flexible(
                    ...
                    Image.asset('assets/icons/Search.png', scale: 7),
                    Padding(
                        padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 10),
                        child: Text('searchMethod'.tr,
                      ...
                      Flexible(
                        child: RawAutocomplete<Result>(
                          ...
                          optionsViewBuilder: (BuildContext context,
                              AutocompleteOnSelected<Result> onSelected, Iterable<Result> options) {
                            return Padding(
                                      ...
                                      await showAdaptiveDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog.adaptive(
                                                title:
                                                    Text('location'.tr, style: context.textTheme.titleLarge),
