...
import 'package:weather_app/app/widgets/daily/weather_daily.dart';
import 'package:weather_app/app/widgets/daily/weather_more.dart';
import 'package:weather_app/app/widgets/desc/desc_container.dart';
import 'package:weather_app/app/widgets/hourly/weather_hourly.dart';
import 'package:weather_app/app/widgets/now/weather_now.dart';
import 'package:weather_app/app/widgets/shimmer.dart';
import 'package:weather_app/app/widgets/sun_moon/sunset_sunrise.dart';
        ...
        child: Obx(() {
          if (weatherController.isLoading.isTrue) {
            return ListView(
              children: const [
                MyShimmer(hight: 350),
                MyShimmer(hight: 130, edgeInsetsMargin: EdgeInsets.symmetric(vertical: 15)),
                MyShimmer(hight: 90, edgeInsetsMargin: EdgeInsets.only(bottom: 15)),
                MyShimmer(hight: 400, edgeInsetsMargin: EdgeInsets.only(bottom: 15)),
                MyShimmer(hight: 450, edgeInsetsMargin: EdgeInsets.only(bottom: 15))
              ],
            );
          }
                      ...
                      child: SizedBox(
                          ...
                          child: ScrollablePositionedList.separated(
                              ...
                              separatorBuilder: (BuildContext context, int index) {
                                return const VerticalDivider(width: 10, indent: 40, endIndent: 40);
                              },
